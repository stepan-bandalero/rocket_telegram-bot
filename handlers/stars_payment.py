...
from models.promo import PromoLink
from models.promo import PromoReferral
...
async def handle_successful_payment(message: Message):
    ...
    async with SessionLocal() as session:
        ...
        # bonus = (invoice.amount * 20) // 100  # целые звёзды
    ...
    # await message.answer(f"✅ Оплата успешна! Начислено {total} ⭐ (из них {bonus} ⭐ бонус 20%)")